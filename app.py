...
def create_verification_html(code):
    ...
    <html>
      <body style="background-color: #ffffff; color: #333333; font-family: Arial, sans-serif; padding: 20px;">
        ...
        <p style="text-align: center; font-size: 18px;">Введите данный код регистрации на нашем сайте, чтобы завершить регистрацию.</p>

        <p style="text-align: center; font-size: 32px; font-weight: bold; margin: 20px 0;">{code}</p>

        <p style="text-align: center;">Спасибо, что выбрали Crosswords! 🎉</p>
        <p style="text-align: center;">Теперь вы в курсе всего важного: свежие новости, эксклюзивные материалы и только самое интересное — без лишнего шума.</p>
        <p style="text-align: center;">Надеемся, вам у нас понравится! Если нужна помощь или есть пожелания — просто напишите.</p>
        <p style="text-align: center;">Всегда на связи.</p>
        <p style="text-align: center;">Приятного чтения! 😊</p>
      </body>
    </html>
    """
    return html
